...
$CONFIGURE_IN = '/torcode/tor-0.2.9.8/configure.ac';
$ORCONFIG_H = '/torcode/tor-0.2.9.8/src/win32/orconfig.h';
$TOR_NSI = '/torcode/tor-0.2.9.8/contrib/win32build/tor-mingw.nsi.in';
