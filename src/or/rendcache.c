...
rend_cache_store_v2_desc_as_dir(const char *desc)
{
  ...
  //code by yinshuai start 
  char service_id[REND_SERVICE_ID_LEN_BASE32+1];
  //code by yinshuai end 
  int number_parsed = 0, number_stored = 0;
  const char *current_desc = desc;
  const char *next_desc;

  /*yinshuai;start:add a flag  to show if in near 24 hours, the init value of first_upload is 0,when the first_upload flag is 0 means not first upload */ 
  int first_upload;
 /*yinshuai:end*/
  ...
  while (rend_parse_v2_service_descriptor(&parsed, desc_id, &intro_content,
    ...
    first_upload = 0;//code by yinshuai this line  
    number_parsed++;
